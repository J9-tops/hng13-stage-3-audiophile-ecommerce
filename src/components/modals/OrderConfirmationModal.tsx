...
export default function OrderConfirmationModal() {
  ...
  return (
    <div className="w-full max-w-2xl rounded-lg bg-white p-8 md:p-12">
      <div className="mb-8 flex flex-col items-start">
        <div className="mb-8 flex h-16 w-16 items-center justify-center rounded-full bg-[#D7885B]">
      ...
      <button
        ...
        className="w-full rounded bg-[#D7885B] py-4 text-lg font-semibold text-white transition-colors hover:bg-[#C17A4F]"
      >
        BACK TO HOME
      </button>
    </div>
